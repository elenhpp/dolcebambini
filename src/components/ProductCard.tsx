    ...
    >
      <div className="shimmer group relative rounded-3xl bg-card border border-border/60 soft-shadow overflow-hidden transition-transform duration-500 hover:-translate-y-1 hover:shadow-lg">
        <div className="relative aspect-[3/4] overflow-hidden bg-muted">
          ...
          />
          <div className="shimmer absolute top-3 left-3 z-[3] rounded-full bg-background/90 backdrop-blur px-3 py-1 text-[10px] tracking-[0.2em] uppercase text-foreground/80 border border-border/60">
