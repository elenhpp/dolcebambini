...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dolce Bambini — Handcrafted Baptism & Communion" },
      { property: "og:description", content: "Handmade baptism and communion garments with romantic, premium elegance — since 1978." },
